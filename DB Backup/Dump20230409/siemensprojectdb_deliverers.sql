...
CREATE TABLE `deliverers` (
  ...
  `deliverer_status` varchar(45) NOT NULL DEFAULT 'NOT_DELIVERING',
...
INSERT INTO `deliverers` VALUES (1,'DELIVERING'),(2,'NOT_DELIVERING'),(3,'DELIVERING'),(4,'NOT_DELIVERING'),(5,'DELIVERING');
